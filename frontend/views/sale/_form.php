...
<div class="income-form ">
    ...
    <div class="main-form-fields">
        ...
        <?= $form->field($model, 'client_id')->widget(Select2::className(), ['data' => Client::getList('name'), 'options' => ['prompt' => ' ']]) ?>
        <?= $form->field($model, 'status', ['options' => ['class' => 'form-group col-md-2']])->widget(Select2::className(), ['data' => $model::statusList()]) ?>
        <?= $form->field($payment, 'pay_type_id', ['options' => ['class' => 'form-group col-md-2']])->widget(Select2::className(), ['data' => PayType::getList(), 'options' => []]) ?>
        <?= $form->field($payment, 'price',['options' => ['class' => 'form-group col-md-2']])->textInput(['type' => 'number']) ?>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-shopping-cart"></i> <?= Yii::t('app', 'Сотилган маҳсулотлар') ?>
                <button type="button" class="pull-right add-item btn btn-success btn-xs"><i
                            class="fa fa-plus"></i> <?= Yii::t('app', 'Сотилаётган маҳсулотни қўшиш') ?>
                </button>
                <div class="clearfix"></div>
            </div>
            <div class="panel-body container-items"><!-- widgetContainer -->
                ...
                <div class="item panel panel-default"><!-- widgetBody -->
                    ...
                    <div class="panel-body">
                        ...
                        <?= $form->field($modelProductLink, "[{$index}]amount")->textInput(['type' => 'number', 'onChange' => "calculateSaleTotalPrice($(this));"]) ?>
                        <?= $form->field($modelProductLink, "[{$index}]price")->textInput(['type' => 'number', 'onChange' => "calculateSaleTotalPrice($(this));"]) ?>
